...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../ECE385_Pokemon.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../ECE385_Pokemon.gen/sources_1/bd/mb_block/ipshared/7698" \
       +incdir+"../../../../ECE385_Pokemon.gen/sources_1/bd/mb_block/ipshared/ec67/hdl" \
       +incdir+"../../../../ECE385_Pokemon.gen/sources_1/bd/mb_block/ipshared/7698" \
       -input simulate.do
}
