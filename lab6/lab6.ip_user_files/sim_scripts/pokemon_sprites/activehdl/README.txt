...
#
# Generated by export_simulation on Wed Nov 15 15:09:34 -0600 2023
#
################################################################################
...
'-reset_run' switch to the './pokemon_sprites.sh' script.

./pokemon_sprites.sh -reset_run
...
./pokemon_sprites.sh -noclean_files

For more information on the script, please type './pokemon_sprites.sh -help'.
