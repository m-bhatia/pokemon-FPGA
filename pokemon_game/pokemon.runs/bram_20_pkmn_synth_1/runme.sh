...
HD_PWD='C:/Users/Mayank/Desktop/385/pokemon_game/pokemon.runs/bram_20_pkmn_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_20_pkmn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_20_pkmn.tcl
