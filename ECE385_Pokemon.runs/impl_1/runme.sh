...
HD_PWD='C:/Users/klok1/Documents/ECE385_Pokemon/ECE385_Pokemon.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pokemon_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pokemon_Top.tcl -notrace
