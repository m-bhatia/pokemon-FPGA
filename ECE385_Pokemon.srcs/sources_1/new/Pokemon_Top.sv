module Pokemon_Top (
    ...
    int SpriteIndex[4] = '{8, 9, 10, 11};
    logic [9:0] SpriteX = PlayerX;
    logic [9:0] SpriteY = PlayerY; 
    ...
    color_mapper color_instance(
        ...
        .Wild_Grass_Player_on(Wild_Grass_on),
        .new_tile(new_tile),
        .bram_data(bram_data),
        .bram_addr(bram_addr),
        .Red(red),
    ...
    blk_mem_gen_0 sprites (
        ...
        .dina(16'b0),         // not used for read-only
